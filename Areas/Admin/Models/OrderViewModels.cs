...
public class OrderDetailViewModel
{
    ...
    /// <summary>Next legal status, or null when the order is finished or cancelled.</summary>
    public OrderStatus? NextStatus { get; set; }

    /// <summary>True when the lifecycle still allows cancelling this order.</summary>
    public bool CancelAllowedByWorkflow { get; set; }

    /// <summary>
    /// False while no service can restore stock for a cancellation. Kept separate from
    /// <see cref="CancelAllowedByWorkflow"/> so the UI can explain *why* the button is off.
    /// </summary>
    public bool CancelSupported { get; set; }

    /// <summary>Shown next to a disabled Cancel button.</summary>
